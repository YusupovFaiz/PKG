...
from funcs import liang_barsky, cyrus_beck
...
class MyApp:
    def __init__(self):
        ...
        self.style.configure("TFrame", background="red", foreground="white")
        ...
        self.btn_file_path = Button(self.menu_frame, text="Browse", command=self.get_file, width=10, bg='#48544b',
                                    font=('Arial', 12, 'bold'), foreground='#FFFFFF')
        self.btn_file_path.pack(side="top", pady=12)

        self.file_path = Entry(self.menu_frame, width=30, bg='#48544b', font=('Arial', 12, 'bold'),
                               foreground='#FFFFFF')
        ...
        self.scale_label = ttk.Label(self.menu_frame, text="Scale", background="red", font=('Arial', 12, 'bold'))
    ...
    def draw_polygon(self):
        ...
        self.canvas.create_polygon(new_window, fill='#48544b', outline='black')
